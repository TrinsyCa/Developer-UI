...
<head>
   ...
   <title>Robotik Kodlama | TrinsyBlog</title>
        ...
        <?php
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="./"><i class="fa-solid fa-code"></i>&nbsp; Robotik Kodlama</a></li>
            <li><hr class="dropdown-divider"></li>
...
<div class="wrapper">
   ...
   <div class="container">
      <div class="row">
      <?php
         $veri = $db->prepare("SELECT * FROM bloglarim WHERE kategori='Robotik Kodlama' ORDER BY id DESC");
         $veri->execute();
