...
<head>
   ...
   <title>Proje Duyuru | TrinsyBlog</title>
        ...
        <?php
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item active" href="./"><i class="fa-solid fa-bullhorn"></i>&nbsp; Proje Duyuru</a></li>
...
<div class="wrapper">
   ...
   <div class="container">
      <div class="row">
      <?php
         $veri = $db->prepare("SELECT * FROM bloglarim WHERE kategori='Proje Duyuru' ORDER BY id DESC");
         $veri->execute();
