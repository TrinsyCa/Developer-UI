...
<head>
   ...
   <title>Vİdeo Dizayn | TrinsyBlog</title>
        ...
        <?php
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="./"><i class="fa-solid fa-video"></i>&nbsp; Video Dizayn</a></li>
...
<div class="wrapper">
   ...
   <div class="container">
      <div class="row">
      <?php
         $veri = $db->prepare("SELECT * FROM bloglarim WHERE kategori='Video Dizayn' ORDER BY id DESC");
         $veri->execute();
