...
<head>
   ...
   <title>Yazılım | TrinsyBlog</title>
        ...
        <?php
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="./"><i class="fa-solid fa-code"></i>&nbsp; Yazılım</a></li>
...
<div class="wrapper">
   ...
   <div class="container">
      <div class="row">
      <?php
         $veri = $db->prepare("SELECT * FROM bloglarim WHERE kategori='Yazılım' ORDER BY id DESC");
         $veri->execute();
